                    ...
                    <div class="row">
                            ...
                            <div class="single-course-wrap">
                                ...
                                <div>
                                    <a href="" class="btn btn-base2" style="width: 100%; text-align:center; border-radius: 0px;">
                                        DIPLOMADOS ESPECIALIZADOS SECTOR EMPRESARIAL
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="single-course-wrap">
                                ...
                                <div>
                                    <a href="" class="btn btn-base2" style="width: 100%; text-align:center; border-radius: 0px;">
                                        DIPLOMADOS ESPECIALIZADOS SECTOR DERECHO
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="single-course-wrap">
                                ...
                                <div>
                                    <a href="" class="btn btn-base2" style="width: 100%; text-align:center; border-radius: 0px;">
                                        DIPLOMADOS ESPECIALIZADOS SECTOR PUBLICO
                                    </a>
                                </div>
                            </div>
                        </div>
