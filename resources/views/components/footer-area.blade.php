                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        ...
                        <div class="footer_contact_widget">
                            ...
                            <div class="contact_info_nbox type_one">
                                <div class="single">
                                    <h6 class="color_white">
                                        <span class="icon-telephone color_white"></span>
                                        Teléfono
                                    </h6>
                                    <p>
                                        <a href="tel:{{ $data[0]->item->content }}" class="color_white">
                                            {{ $data[0]->item->content }}
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div class="contact_info_nbox type_one">
                                <div class="single">
                                    ...
                                    <p><a href="mailto:support@creote.com" class="color_white">support@creote.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
