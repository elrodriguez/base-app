<template>
   <div class="text-center">
    <input @change="handleFileChange" accept=".svg, .png, .jpg, .jpeg, .gif" class="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-success/90 ltr:file:mr-5 rtl:file:ml-5 file:text-white file:hover:bg-success" id="compressorjs-input" type="file">
