...
<template>
    <div class="w-full">
        <button type="button" @click="triggerFileInput" class="btn w-full btn-outline-dark">
            <svg v-if="loading" aria-hidden="true" class="w-4 h-4 me-2 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
