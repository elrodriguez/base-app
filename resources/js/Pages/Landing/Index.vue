<template>
                ...
                <div class="yb zd">
                    <nav>
                        <ul class="navbar hb ld od pd sd kh sn vn xn yn">
                            <li>
                                <a href="#home" class="menu-scroll active ib od pd kh lh mh bi _i ek">
                                    Home
                                </a>
                            </li>
                            <li>
                                <a href="#features" class="menu-scroll ib od pd kh lh mh bi _i ek">
                                    Features
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="#support" class="menu-scroll ib od pd kh lh mh bi _i ek">
                                    Support
                                </a>
                            </li>
                        </ul>
            ...
            <div class="ja hb md od">
                <div class="yb yf pn/2">
                    <div class="ia wa qc kh bn cn _o">
                        <span class="wow fadeInUp na gb ee se af zf lf lh mh ei vj yj _j" data-wow-delay=".2s">
                            <span class="_a gb rb ec ee se"></span>
                            Tailwind Template for Startups
                        </span>
                        <h1 class="wow 
                fadeInUp oa lh qh wh _j dl qm um" data-wow-delay=".3s">
                            Digital Solutions for Your

                            <span class="txt-type hi" data-wait="3000"
                        ...
                        <p class="wow fadeInUp wa mh bi" data-wow-delay=".4s">
                            ...
                            Comes with refreshing design and everything you need to kickstart your next web project.
                        </p>
                ...
                <div class="yb of pn/2">
                    <div class="wow fadeInRight e ga ia sb yb rc bn" data-wow-delay=".3s">
            ...
            <div class="ja hb md pd">
                <div class="yb of yl/2 pn/3">
                    <div class="wow fadeInUp bj ia pa tc kh nl" data-wow-delay=".2s">
                        <div class="ia ra hb tb fc od pd ee se af ei ti dj ej fj vj zj _j hk ik ol tl zl">
                        ...
                        <div>
                            <h3 class="ab lh th xh di _j el pl">
    ...
    <section id="about" class="ig zk oo">
        <div class="of op">
            ...
            <div class="wow fadeInUp e da _d de qf wg xg gm jm io so up xp" data-wow-delay=".3s">
                ...
                <div class="tabButtons hb yb od rd">
                    <button class="yb ie sf yg zg lh mh xh vi _i pj _j ck to uo" onclick="showPanel(0)">
                        About Us
                    </button>
                    <button class="yb ie sf yg zg lh mh xh vi _i pj _j ck to uo" onclick="showPanel(1)">
                        Our Mission
                    </button>
                    <button class="yb ie sf yg zg lh mh xh vi _i pj _j ck to uo" onclick="showPanel(2)">
                        Our Vision
                    </button>
                </div>
                <div class="yb">
                            ...
                            <div class="yb of pn/2">
                                <div class="e ga xa ub vc cn">
                                    ...
                                    <div class="d k i/2 da cd/2">
                                        ...
                                        <div class="d t u ea ob yb he ne pe se af qi oj rj vj yj"></div>
                                    </div>
                                    <div class="d k v fa">
                                        <svg width="72" height="38" viewBox="0 0 72 38" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="ja hb md pd">
                <div class="yb of yl/2 pn/4">
                    <div class="wow fadeInUp bj ia pa wc kh fq" data-wow-delay=".2s">
                        <div class="e na _d de">
                            <img src="src/images/team/image-1.jpg" alt="team-image" class="yb" />
                        ...
                        <div>
                            <h3 class="bb lh th xh di _j el">
                                Olivia Andrium
                            </h3>
                            <p class="font-heading mh bi">
                                Project Manager
                            </p>
                        </div>
                    </div>
                ...
                <div class="yb of yl/2 pn/4">
                    <div class="wow fadeInUp bj ia pa wc kh fq" data-wow-delay=".25s">
                        <div class="e na _d de">
                            <img src="src/images/team/image-2.jpg" alt="team-image" class="yb" />
                            <div class="duration-300 d w o/2 dd/2 ed ki ti cj gj">
                                <div class="hb od pd wd">
                                    <a href="javascript:void(0)" name="social-icon" aria-label="social-icon"
                                        class="hb pb cc od pd ee he me pe re bf ci ri ti wi xi zi">
                ...
                <div class="yb of yl/2 pn/4">
                    <div class="wow fadeInUp bj ia pa wc kh fq" data-wow-delay=".3s">
                        <div class="e na _d de">
                            <img src="src/images/team/image-3.jpg" alt="team-image" class="yb" />
                            <div class="duration-300 d w o/2 dd/2 ed ki ti cj gj">
                                <div class="hb od pd wd">
                                    <a href="javascript:void(0)" name="social-icon" aria-label="social-icon"
                                        class="hb pb cc od pd ee he me pe re bf ci ri ti wi xi zi">
    ...
    <section id="portfolio" class="ig zk oo">
        <div class="of op">
            ...
            <div class="yb">
                <div class="portfolio-btn-wrapper wow fadeInUp cb hb od pd ae ah" data-wow-delay=".2s">
                ...
                <div class="portfolio-grid ja hb md">
                    ...
                    <div class="grid-item ecom yb of on/3">
                        <div class="wow fadeInUp bj e pa _d de" data-wow-delay=".2s">
                            <img src="src/images/portfolio/image-1.jpg" alt="portfolio-image" class="yb" />
                            <div
                    ...
                    <div class="grid-item branding yb of yl/2 pn/3">
                        <div class="wow fadeInUp bj e pa _d de" data-wow-delay=".25s">
                            <img src="src/images/portfolio/image-2.jpg" alt="portfolio-image" class="yb" />
                            <div
                                class="duration-300 d l q hb fd od qd de xe cf tf of ki si ti cj gj jk uk _m jo vp 2xl:ud-left-8">
                                <div class="le oe qe bh al vo yp">
                                    <h3 class="font-heading mh xh ci gl cp aq">
                    ...
                    <div class="grid-item digital yb of yl/2 pn/3">
                        <div class="wow fadeInUp bj e pa _d de" data-wow-delay=".3s">
                            <img src="src/images/portfolio/image-3.jpg" alt="portfolio-image" class="yb" />
                            <div
                                class="duration-300 d l q hb fd od qd de xe cf tf of ki si ti cj gj jk uk _m jo vp 2xl:ud-left-8">
                                <div class="le oe qe bh al vo yp">
                                    <h3 class="font-heading mh xh ci gl cp aq">
                    ...
                    <div class="grid-item ecom yb of yl/2 pn/3">
                        <div class="wow fadeInUp bj e pa _d de" data-wow-delay=".35s">
                            <img src="src/images/portfolio/image-4.jpg" alt="portfolio-image" class="yb" />
                            <div
                                class="duration-300 d l q hb fd od qd de xe cf tf of ki si ti cj gj jk uk _m jo vp 2xl:ud-left-8">
                                <div class="le oe qe bh al vo yp">
                                    <h3 class="font-heading mh xh ci gl cp aq">
    ...
    <section id="testimonial" class="ig zk oo">
        <div class="of op">
            ...
            <div class="yb of">
                <div class="wow fadeInUp e da _d de ff gf _f dh eh pi bk vk cm km xo" data-wow-delay=".3s">
                    <div class="d f g ea ob yb ff gf li ak ef"></div>
                    <div class="d h o/2 ea dd/2">
                        <svg width="1174" height="560" viewBox="0 0 1174 560" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="yb of pn/2">
                                    <div class="lg:mr-0 e ia sa vb yb zc cn">
                                        <div class="d j p da">
                                            ...
                                            <div class="d x u ea ob yb he ne pe se af qi oj rj vj yj"></div>
                                        </div>
                                        <div class="d y z fa">
                                            <svg width="72" height="38" viewBox="0 0 72 38" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="wow fadeInUp ja hb md" data-wow-delay=".2s">
                    <div class="yb of">
                        <div class="hb md od pd">
                            <a href="javascript:void(0)" class="ma hb gc od pd tf 2xl:ud-w-[180px]">
                                <img src="src/images/brands/uideck.svg" alt="image" class="jb pb yb hj" />
                                <img src="src/images/brands/uideck-2.svg" alt="image" class="pb yb ij" />
                            </a>
                            <a href="javascript:void(0)" class="ma hb gc od pd tf 2xl:ud-w-[180px]">
                                <img src="src/images/brands/ayroui.svg" alt="image" class="jb pb yb hj" />
                                <img src="src/images/brands/ayroui-2.svg" alt="image" class="pb yb ij" />
                            </a>
                            <a href="javascript:void(0)" class="ma hb gc od pd tf 2xl:ud-w-[180px]">
                                <img src="src/images/brands/graygrids.svg" alt="image" class="jb pb yb hj" />
                                <img src="src/images/brands/graygrids-2.svg" alt="image" class="pb yb ij" />
                            </a>
                            <a href="javascript:void(0)" class="ma hb gc od pd tf 2xl:ud-w-[180px]">
                                <img src="src/images/brands/lineicons.svg" alt="image" class="jb pb yb hj" />
                                <img src="src/images/brands/lineicons-2.svg" alt="image" class="pb yb ij" />
                            </a>
                            <a href="javascript:void(0)" class="ma hb gc od pd tf 2xl:ud-w-[180px]">
                                <img src="src/images/brands/plainadmin.svg" alt="image" class="jb pb yb hj" />
                                <img src="src/images/brands/plainadmin-2.svg" alt="image" class="pb yb ij" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="e da hb md pd _d de pi bk">
                ...
                <div class="yb ok/2 pn/3">
                    <div class="wow fadeInUp tg gg kh" data-wow-delay=".2s">
                        ...
                        <a href="javascript:void(0)" class="ib od de ze pf qf lh mh ci xi">
                            Join This Plan
                            <span class="dg">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="ja hb md pd">
                <div class="yb of rp/12">
                    <div class="hb md od ie ih jj zo">
                        ...
                        <div class="yb of pn/2">
                            <div class="wow fadeInUp hb od" data-wow-delay=".2s">
                                ...
                                <a href="/cdn-cgi/l/email-protection#1871767e77587f776b6c796a6c6d68367b7775"
                                    class="lh th di _j rm bp cq">
                                    <span class="__cf_email__"
                                        data-cfemail="b7ded9d1d8f7d0d8c4c3d6c5c3c2c799d4d8da">[email&#160;protected]</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="wow fadeInUp ja hb md pg" data-wow-delay=".2s">
                        <div class="yb of yl/2 pn/4">
                            <div class="ra">
                                <h3 class="db lh mh di _j gl">
                                    Email Address
                                </h3>
                                <p class="mh xh bi">
                                    <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="c0b3b5b0b0afb2b480b3b4a1b2b4b5b0eea3afad">[email&#160;protected]</a>
                                </p>
                            </div>
                        </div>
                        <div class="yb of yl/2 pn/4">
                        ...
                        <div class="yb of">
                            <div class="pa">
                                ...
                                <textarea rows="4" name="message" id="message" placeholder="Type Message"
                                    class="yb kd ie ve tf mh xh di ii oi aj mj _j gk"></textarea>
                            </div>
                        </div>
                        <div class="yb of">
                            <div class="wa">
    ...
    <section id="cta" class="ig zk oo">
        <div class="of op">
            <div class="wow fadeInUp e _d ff gf bg _f pi bk xk" data-wow-delay=".2s">
                <div class="d f g ea ob yb ff gf li ak ef"></div>
                <div class="d h o/2 ea dd/2">
                    <svg width="1215" height="259" viewBox="0 0 1215 259" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.6" filter="url(#filter0_f_63_363)">
                            <rect x="450" y="189" width="315" height="378"
                    ...
                    <div class="qa">
                        ...
                        <div class="vd">
                            ...
                            <div>
                                ...
                                <a href="/cdn-cgi/l/email-protection#4e3d3b3e3e213c3a0e2a21232f2720602d2123"
                                    class="lh mh di _i _j fk">
                                    <span class="__cf_email__"
                                        data-cfemail="e794929797889593a783888a868e89c984888a">[email&#160;protected]</span>
                                </a>
                            </div>
                        </div>
                    </div>
