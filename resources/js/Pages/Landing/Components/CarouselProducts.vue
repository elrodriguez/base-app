...
const pictures = [
  {src: xAssetUrl+ 'img/Landing/slider/slider-1-1.jpg', alt: 'Image 1'},
  {src: xAssetUrl+ 'img/Landing/slider/slider-2.jpg', alt: 'Image 2'},
  {src: xAssetUrl+ 'img/Landing/slider/style2/1.jpg', alt: 'Image 3'},
]
</script>
<template>
