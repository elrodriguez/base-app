...
class WebController extends Controller
{
    ...
    public function testimage($content)
    {
        ...
        $img = Image::make('https://marketplace.canva.com/EAFZ0gzpdOA/1/0/1600w/canva-diploma-certificado-t%C3%ADtulo-curso-clase-cursillo-profesional-elegante-dorado-_FaiOdj4-yw.jpg');
