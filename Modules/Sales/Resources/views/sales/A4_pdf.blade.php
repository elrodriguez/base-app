                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="60%" align="left">
                                        ...
                                        {{ \Carbon\Carbon::parse($sale->created_at)->format('Y-m-d H:i:s') }}
                                    </td>
                                    <td width="40%" align="left">
                                        <strong>Dirección: </strong>
                                        {{ $client->address }}
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $item)
                                    @php
                                        ...
                                        $unit_type = isset($json['unit_type']) ? $json['unit_type'] : null;
                                        $size = isset($json['size']) ? $json['size'] : null;
                                        $interne = isset($json['interne']) ? $json['interne'] : null;
                                    @endphp
                                    <tr class="border_top">
                                        <td align="right">
                                            {{ (int) $item->quantity }}
                                        ...
                                        <td align="left" width="300px">
                                            <span>
                                                {{ json_decode($item->product, true)['description'] }}
                                                {{ $size ? ' / ' . $size : '' }}
                                            </span>
                                        </td>
                                        {{-- <td align="right">
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    ...
                                                    <span
                                                        ...
                                                        text-align="center">
                                                        <strong>
                                                            {{ $numberletters->convertToLetter($sale->total) }}
                                                        </strong>
                                                    </span>
                                                    <br>
                                                    <br>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td width="85%">
                                        <blockquote>
                                            <div>Visite nuestra pagina web <a
                                                    href="{{ route('index_main') }}">{{ env('APP_URL') }}</a>
                                            </div>
