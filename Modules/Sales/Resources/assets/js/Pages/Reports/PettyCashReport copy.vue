            ...
            <nav class="flex px-4 py-3 border border-stroke text-gray-700 mb-4 bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg aria-hidden="true" class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <Link href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Caja Chica</Link>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                                ...
                                <thead class="border-b border-stroke">
                                    ...
                                    <tr class="bg-gray-50 text-left dark:bg-meta-4">
                                        ...
                                        <th colspan="7" class="py-1 px-4 text-left font-medium text-black dark:text-white">
                                            {{ props.petty_cash.date_opening +" "+ props.petty_cash.time_opening.slice(0, -3) }} <strong>cerrado  el:</strong> {{ props.petty_cash.date_closed +" "+ props.petty_cash.time_closed ? props.petty_cash.time_closed.slice(0, -3) : null }}
                                        </th>
                                    </tr>
                                    <tr class="bg-gray-50 text-left dark:bg-meta-4">
