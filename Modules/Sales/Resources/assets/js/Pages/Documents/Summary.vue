                        ...
                        <table class="w-full table-auto">
                            ...
                            <tbody>
                                <template v-for="(summary, index) in summaries.data" :key="summary.id">
                                    <tr :style="summary.status ==='registrado' ? '' : summary.status ==='Rechazada' ? 'color: #CF1504': 'color: #051BC6'" :class="summary.invoice_status ==='registrado' ? 'border-b border-stroke' : ''">
                                        <td :rowspan="summary.status ==='registrado' ? 1 : 2" class="text-center py-2 px-2 dark:border-strokedark">
                                    ...
                                    <template v-if="summary.status !='registrado'" >
                                        <tr :style="summary.status ==='registrado' ? '' : summary.status ==='Rechazada' ? 'color: #CF1504': 'color: #051BC6'" class="border-b border-stroke" >
