            ...
            <template #content>
                <div class="grid grid-cols-6 gap-6">
                                ...
                                <li class="mb-2">
                                    <div class="w-full p-2 text-green-700 border border-green-300 rounded-lg bg-green-200 dark:bg-gray-800 dark:border-green-800 dark:text-green-400" >
                                        <div class="flex items-center">   
                                            <label for="simple-module" class="sr-only">Clase</label>
                                            <div class="relative w-20 mr-1">
                                                <input v-model="form.position" type="text" id="simple-module" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Posición" required>
                                            </div>
                                            <div class="relative w-full">
                                                <input v-model="form.description" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                            </div>
                                    ...
                                    <TimelineContent>
                                        <TimelineTitle>
                                            <div class="flex items-center">   
                                                ...
                                                <div class="relative w-20 mr-1">
                                                    <input v-model="module.position" type="text" :id="'position'+index" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Posición" required>
                                                </div>
                                                <div class="relative w-full">
                                                    <input v-model="module.description"  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                                </div>
                    ...
                    <div v-if="formTheme.module_id" class="col-span-6 sm:col-span-3" >
                        <div class="px-2">
                            <ol class="space-y-4 w-full" >
                                <li class="mb-2">
                                    <div class="w-full p-2 text-green-700 border border-green-300 rounded-lg bg-green-200 dark:bg-gray-800 dark:border-green-800 dark:text-green-400" >
                                        <div class="flex items-center">   
                                            <label for="simple-module" class="sr-only">tema</label>
                                            <div class="relative w-20 mr-1">
                                                <input v-model="formTheme.position" type="text" id="simple-module" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Posición" required>
                                            </div>
                                            <div class="relative w-full">
                                                <input v-model="formTheme.description" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                            </div>
                        ...
                        <div style="max-height: 350px; overflow-y: auto;" class="px-2">
                            <div v-if="loadingThemes" role="status" class="w-full animate-pulse">
                                <div class="h-4 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[530px] mb-4"></div>
                                <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[330px] mb-2.5"></div>
                                <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[530px] mb-2.5"></div>
                                <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[330px] mb-2.5"></div>
                                    ...
                                    <TimelineContent>
                                        <TimelineTitle>
                                            <div class="flex items-center">   
                                                ...
                                                <div class="relative w-20 mr-1">
                                                    <input v-model="theme.position" type="text" :id="'theme-titble'+key" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                                                </div>
                                                <div class="relative w-full">
                                                    <input v-model="theme.description" type="text" :id="'theme-titble'+key" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-1.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                                                </div>
