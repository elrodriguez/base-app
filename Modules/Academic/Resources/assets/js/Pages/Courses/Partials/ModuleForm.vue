...
onMounted(() => {
    modulesLoading.value = form.modules.map(() => ({ loading: false }));
    form.modules = props.course.modules;
});
        ...
        <div class="col-span-6 sm:col-span-3" >
            <div class="px-2">
                <ol class="space-y-4 w-full" >
                    <li class="mb-2">
                        <div class="w-full p-4 text-green-700 border border-green-300 rounded-lg bg-green-200 dark:bg-gray-800 dark:border-green-800 dark:text-green-400" >
                            <div class="flex items-center">   
                                <label for="simple-module" class="sr-only">Modulo</label>
                                <div class="relative w-40 mr-1">
                                    <input v-model="form.position" type="text" id="simple-module" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Posición" required>
                                </div>
                                <div class="relative w-full">
                                    <input v-model="form.description" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nombre del Modulo" required>
                                </div>
                                <button @click="saveModuleNew" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" type="button" class="ml-1 inline-flex items-center px-4 py-3 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
            ...
            <div style="max-height: 350px; overflow-y: auto;" class="px-2">
                <ol class="space-y-4 w-full" >
                    <li v-for="(module, index) in form.modules" class="mb-2">
                        <div class="w-full p-4 text-green-700 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:border-green-800 dark:text-green-400" >
                            <div class="flex items-center">   
                                ...
                                <div class="relative w-40 mr-1">
                                    <input v-model="module.position" type="text" :id="'position'+index" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Posición" required>
                                </div>
                                <div class="relative w-full">
                                    <input v-model="module.description"  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nombre del Modulo" required>
                                </div>
                                <button @click="saveModuleUpdate(index,module)" :class="{ 'opacity-25': modulesLoading[index].loading }" :disabled="modulesLoading[index].loading" type="button" title="Actualizar"  class="ml-1 inline-flex items-center px-3 py-3 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
