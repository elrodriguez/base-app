                                        ...
                                        <td class="text-center py-2 dark:border-strokedark">
                                            <dropdown>
                                                ...
                                                <div class="dropdown-div z-10 absolute text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                                    <ul class="py-2">
                                                        <li>
                                                            <a @click="openModalAgreements(course)" href="#" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Convenios</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </dropdown>
