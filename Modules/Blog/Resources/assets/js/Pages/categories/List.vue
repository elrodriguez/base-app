                    ...
                    <div class="w-full p-4">
                        <div class="grid grid-cols-3">
                            ...
                            <div class="col-span-3 sm:col-span-2">
                                <Keypad>
                                    <template #botones>
                                        <Link :href="route('blog-category.create')" class="flex items-center justify-center inline-block px-6 py-2.5 bg-blue-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                            Nuevo
                                        </Link>
                                    </template>
                                </Keypad>
                                ...
                                <tr v-for="(category, index) in categories.data" :key="category.id" >
                                    <td>
                                        <div class="flex gap-4 items-center justify-center">
                                            <a :href="route('blog-category.edit',category.id)" class="btn btn-sm btn-outline-primary">
                                                <font-awesome-icon :icon="faPencilAlt" />
                                            </a>
                                            <button @click="destroyCategory(category.id)" type="button" class="btn btn-sm btn-outline-danger">
