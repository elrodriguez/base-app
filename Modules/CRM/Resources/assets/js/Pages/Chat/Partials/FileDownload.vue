...
<template>
    <div class="flex items-start bg-black/10 dark:bg-gray-800 rounded-xl p-2">
        <div class="me-2">
            <span class="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white-dark pb-2">
