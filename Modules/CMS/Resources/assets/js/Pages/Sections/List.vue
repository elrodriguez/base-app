                    ...
                    <div class="w-full p-4 border-b border-gray-200 bg-gray-50 rounded-t-xl dark:border-gray-600 dark:bg-gray-700">
                        <div class="grid grid-cols-3">
                            ...
                            <div class="col-span-3 sm:col-span-2">
                                <Keypad>
                                    <template #botones>
                                        <Link v-can="'cms_editor'" :href="route('cms_section_create')" class="flex items-center justify-center inline-block px-6 py-2.5 bg-blue-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                            Nueva Sección
                                        </Link>
                                    </template>
                                </Keypad>
                                ...
                                <template v-for="(item, index) in sections.data" :key="item.id">
                                    <tr class="border-b border-stroke">
                                        <td class="text-center py-2 dark:border-strokedark">
                                            ...
                                            <Link v-can="'cms_editor'" :href="route('cms_section_edit',item.id)" class="mr-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                <font-awesome-icon :icon="faPencilAlt" />
                                            </Link>
                                            <Link v-can="'cms_seccion'" :href="route('cms_section_items',item.id)" class="mr-1 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" title="Agregar Items a esta sección">
                                                <font-awesome-icon :icon="faPlus" />
                                            </Link>
                                            <Link v-can="'cms_seccion'" :href="route('cms_section_group_items',item.id)" class="mr-1 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full text-sm py-2.5 px-2 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" title="Crear Grupo de Items">
