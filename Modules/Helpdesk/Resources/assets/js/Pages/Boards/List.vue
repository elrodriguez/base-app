                                    ...
                                    <div style="height: 180px;" class="w-full bg-gray-100 max-w-sm  border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div class="flex flex-col items-center pb-10">
                                            ...
                                            <div class="flex mb-4 mt-4 space-x-3 sm:mb-6 sm:mt-6">
                                                <button @click="showModalLevels(board)" v-can="'help_tableros_miembros'" type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                    Niveles
                                                </button>
