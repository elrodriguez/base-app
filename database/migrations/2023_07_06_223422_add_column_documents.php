...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('sale_documents', function (Blueprint $table) {
            ...
            $table->decimal('invoice_total_taxes', 10, 2)->nullable()->comment('total impuestos');
            $table->decimal('invoice_value_sale', 10, 2)->nullable()->comment('valor de la venta');
            $table->decimal('invoice_subtotal', 10, 2)->nullable()->comment('valor de la venta');
            $table->decimal('invoice_rounding', 10, 2)->nullable()->comment('redondeo');
            $table->decimal('invoice_mto_imp_sale', 10, 2)->nullable()->comment('monto importe venta');
