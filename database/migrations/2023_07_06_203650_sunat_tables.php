...
return new class extends Migration
{
    public function up()
    {
        ...
        DB::table('sunat_catalogs')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_currency_types', function (Blueprint $table) {
        ...
        DB::table('sunat_currency_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_unit_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('symbol')->nullable();
            $table->string('description');
        ...
        DB::table('sunat_unit_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_affectation_igv_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
        ...
        DB::table('sunat_affectation_igv_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_system_isc_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_system_isc_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_note_credit_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_note_credit_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_note_debit_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_note_debit_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_related_tax_document_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_related_tax_document_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_other_tax_concept_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_other_tax_concept_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_price_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_price_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_transport_mode_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_transport_mode_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_summary_status_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_summary_status_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_transfer_reason_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_transfer_reason_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_related_documents_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_related_documents_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_perception_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
        ...
        DB::table('sunat_perception_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_retention_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->decimal('percentage', 10, 2);
            $table->string('description');
        ...
        DB::table('sunat_retention_types')->insert([
        ...
        DB::table('sunat_operation_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_legend_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_legend_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_charge_discount_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->boolean('base');
        ...
        DB::table('sunat_charge_discount_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_attribute_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_attribute_types')->insert([
         ...
         ***************************************************************************************************************
         */
        Schema::create('sunat_payment_method_types', function (Blueprint $table) {
            $table->string('id')->index();
            $table->boolean('active');
            $table->string('description');
        });

        DB::table('sunat_payment_method_types')->insert([
    ...
    {
        Schema::dropIfExists('sunat_payment_method_types');
        Schema::dropIfExists('sunat_attribute_types');
        Schema::dropIfExists('sunat_charge_discount_types');
        Schema::dropIfExists('sunat_legend_types');
        Schema::dropIfExists('sunat_operation_types');
        Schema::dropIfExists('sunat_retention_types');
        Schema::dropIfExists('sunat_perception_types');
        Schema::dropIfExists('sunat_related_documents_types');
        Schema::dropIfExists('sunat_transfer_reason_types');
        Schema::dropIfExists('sunat_summary_status_types');
        Schema::dropIfExists('sunat_transport_mode_types');
        Schema::dropIfExists('sunat_price_types');
        Schema::dropIfExists('sunat_other_tax_concept_types');
        Schema::dropIfExists('sunat_related_tax_document_types');
        Schema::dropIfExists('sunat_note_debit_types');
        Schema::dropIfExists('sunat_note_credit_types');
        Schema::dropIfExists('sunat_system_isc_types');
        Schema::dropIfExists('sunat_affectation_igv_types');
        Schema::dropIfExists('sunat_unit_types');
        Schema::dropIfExists('sunat_currency_types');
    }
};
